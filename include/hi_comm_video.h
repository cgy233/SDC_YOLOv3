...
typedef struct hiLDCV2_ATTR_S
{
    ...
    HI_S32 aas32SrcCaliRatio[2][4]; /*RW; lens distortion coefficients of the source image, with 5 decimal numbers*/
    HI_S32 s32SrcJunPt;             /*RW; Junction Point of the two segments*/

    HI_S32 aas32DstCaliRatio[3][4]; /*RW; lens distortion coefficients, with 5 decimal numbers*/
    HI_S32 s32DstJunPt[2];          /*RW; Junction Point of the three segments*/
} LDCV2_ATTR_S;
